					...
					switch (AbsatzOption)
					{
						case alsTabelleFormatOption:
						{
							...
							if ([tempKommentarArray count]==0)
							{
								...
								[returnDic setObject:@"Keine Anmerkungen für diese Einstellungen" forKey:@"kommentarstring"];
...
//**********	
	...
	if ([returnKommentarStringArray count]==0)
	{
		...
		NSString* keinKommentarString=@"Keine Anmerkungen für diese Einstellungen";
	...
	if (tempProjektNamenOptionNumber )
	{
		...
		switch (AuswahlOption)
		{
			...
			case alleVonTitelKommentarOption:
			{
				...
				{
					[KommentarFenster setPopBMenu:LeserArray erstesItem:@"alle" aktuell:NULL mitPrompt:@"für Leser:"];
				}
